...
export class ProfileContextEngine {
    static buildContext(profile) {
        ...
        return {
            ...
            primaryGoal: (profile.goals && typeof profile.goals.primary === 'string') ? profile.goals.primary : 'General Wellness',
            secondaryGoals: (profile.goals && Array.isArray(profile.goals.secondary)) ? profile.goals.secondary : [],
